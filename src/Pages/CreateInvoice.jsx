                ...
                <div className="sm:col-span-2">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setErrors((p) => ({
                        ...p,
                        newCustomer: { ...p.newCustomer, customer_name: "" },
                        general: "",
                      }))
                    }}
                  />
                ...
                <div className="sm:col-span-2">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setErrors((p) => ({
                        ...p,
                        newCustomer: { ...p.newCustomer, customer_phone: "" },
                        general: "",
                      }))
                    }}
                  />
                ...
                <div className="sm:col-span-2">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setErrors((p) => ({
                        ...p,
                        newCustomer: { ...p.newCustomer, customer_email: "" },
                        general: "",
                      }))
                    }}
                  />
                ...
                <div className="sm:col-span-2">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setErrors((p) => ({
                        ...p,
                        newVehicle: { ...p.newVehicle, vehicle_vin: "" },
                        general: "",
                      }))
                    }}
                  />
